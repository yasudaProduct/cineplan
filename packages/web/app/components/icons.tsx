...
// UI 用インライン SVG アイコン集（docs/spec/07 §3: ワイヤー中の記号はアイコンに置換する。絵文字は使わない）。
// 依存パッケージを増やさないため自前定義。stroke ベース・currentColor・1em 基準でテキストに追従する。
...
export function IconStar({ filled = false, ...props }: IconProps & { filled?: boolean }) {
  return (
    <Icon fill={filled ? 'currentColor' : 'none'} {...props}>
      <path d="M12 2.5 15 8.6l6.7 1-4.85 4.72 1.15 6.68L12 17.85 6 21l1.15-6.68L2.3 9.6l6.7-1Z" />
    </Icon>
  )
}
